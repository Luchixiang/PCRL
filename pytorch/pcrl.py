...
from models.pcrl_model import PCRLModel
...
def train_pcrl_2d(args, data_loader, out_channel=3):
    ...
    model = PCRLModel(student=True)
    model_ema = PCRLModel(student=False)
    model = model.cuda()
    ...
    for epoch in range(0, args.epochs + 1):
        ...
        if epoch % 60 == 0:
            ...
            state = {'opt': args, 'state_dict': model.module.model.encoder.state_dict(),
                     'decoder_state_dict': model.module.model.decoder.state_dict(),
